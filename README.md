...
- **Audio Controls**: Easy mute/unmute and play/pause buttons in the header
- **Keyboard Shortcuts**:
  - Mute/unmute audio with ALT+M (mutes all sounds)
  - Play/pause music with Spacebar (controls background music only)
...
- **OS Media Controls**: Support for media keys on keyboards and OS media controls (play/pause)
